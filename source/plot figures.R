#Figure 1.
pr=read.csv(paste0('./output intermediate/rp_owned_',file_suffix,'.csv'),header=T,stringsAsFactors = F)
data=pr%>%
...
#Figure 2. 
rent_own_ratio=read.csv(paste0('./output intermediate/rent_own_ratio_',file_suffix,'.csv'),
...
#Figure 3
net_yield=read.csv(paste0('./output final/net_yield_',file_suffix,'.csv'),header=T,stringsAsFactors = F)

regions=read.csv(paste0('./input data/',file_suffix,'.csv'),header=T,stringsAsFactors = F)
#your own HPI data
hpi=read.csv('./input data/HPI_master.csv',header=T,stringsAsFactors = F)%>%
  filter(level=='MSA',
