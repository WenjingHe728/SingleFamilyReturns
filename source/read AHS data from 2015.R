...
# This script reads AHS data from 2015 to 2019 and save data_ahs_from2015.RData.
...
filenames=c('D:/Data/AHS/CVS/ahs2015n.csv',
...
saveRDS(data_ahs,file='./input data/data_ahs_from2015.RData')
